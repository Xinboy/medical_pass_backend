...
CREATE DATABASE IF NOT EXISTS `mp_cmn` CHARACTER SET utf8;
USE `mp_cmn`;
...
CREATE DATABASE IF NOT EXISTS `mp_hosp` CHARACTER SET utf8mb4;
USE `mp_hosp`;
...
CREATE DATABASE IF NOT EXISTS `mp_order` CHARACTER SET utf8;
USE `mp_order`;
...
CREATE DATABASE IF NOT EXISTS `mp_user` CHARACTER SET utf8;
USE `mp_user`;
